...
<head>
    <meta charset="UTF-8">
    <title>Zarejestruj Użytkownika</title>
...
<div class="row">
    <div class="col-sm-3">
        <div class="card custom-bg ml-5 mr-3 mb-5">
            ...
            <div class="card-body">
                <a href="/adminregister" class="card-title non-underline-link text-color non-underline-link"><h2 class="card-title text-center text-color">Administrator</h2></a>
    ...
    <div class="col-sm-3">
        <div class="card custom-bg ml-5 mr-3 mb-5">
            ...
            <div class="card-body">
                <a href="/doctorregister" class="card-title non-underline-link text-color non-underline-link"><h2 class="card-title text-center text-color">Lekarz</h2></a>
    ...
    <div class="col-sm-3">
        <div class="card custom-bg ml-5 mr-3 mb-5">
            ...
            <div class="card-body">
                <a href="/pharmacistregister" class="card-title non-underline-link text-color non-underline-link"><h2 class="card-title text-center text-color">Farmaceuta</h2></a>
    ...
    <div class="col-sm-3">
        <div class="card custom-bg ml-5 mr-3 mb-5">
            ...
            <div class="card-body">
                <a href="/receptionistregister" class="card-title non-underline-link text-color non-underline-link"><h2 class="card-title text-center text-color">Recepcjonista</h2></a>
