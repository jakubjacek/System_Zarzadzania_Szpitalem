...
<%@ page import ="jj.systemszpitalny.*"%>
...
<head>
    <meta charset="UTF-8">
    <title>Dodaj Dystrybutora</title>
        ...
        <div class="col-md-4 offset-md-4 admin" >
            <div class="card">
                ...
                <div class="card-body px-5">
                    <h3 class="text-center my-3">Dodaj Firmę</h3>
                    <form action="addmedicinecompany" method="post">
                        ...
                        <div class="container text-center">
                            <button class="btn custom-bg text-color"><b>Dodaj Firmę</b></button>
                        </div>
