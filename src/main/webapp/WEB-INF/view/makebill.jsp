        ...
        <div class="col-md-4 mx-auto" >
            <div class="card card-border mx-auto" style="width: 35rem;">
                ...
                <div class="card-body px-5 mx-auto">
                    <h3 class="text-center my-3">Szczegóły wizyty</h3>
                    <div class="container">
                        <form action="bill">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label for="email">Imię Pacjenta</label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Przepisane Lekarstwa</label>
                      ...
                      %>
                            ...
                            <div class="form-group">
                                <label for="email">Całkowita cena leków</label>
                            ...
                            <div class="form-check">
                                <label class="form-check-label" for="exampleCheck1">Czy chce Lekarstwa ze szpitala</label><br>
                            ...
                            <div class="container text-center">
                                <button class="btn custom-bg text-color"><b>Wystaw Rachunek</b></button>
                            </div>
